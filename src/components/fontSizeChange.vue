<template>
    <div class="changeFontSizeWindow">
        <div class="controlWindow">
            <div class="title"><p>字号选择</p></div>
            <img class="close" src="@/assets/img/close.png" @click="closeWindow">
...
const choseList:any = ref(["小号","标准","大号"])
const selectedStandard = ref("标准")
const u = navigator.userAgent;
const isiOS = !!u.match(/\(i[^;]+;( U;)? CPU.+Mac OS X/);
onMounted(()=>{
    // console.log(9998,props.contentList);
...
const emit = defineEmits(["choosebutton","close"])
const chooseButton = (str:string)=>{
  emit("choosebutton",str)
}

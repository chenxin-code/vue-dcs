<template>
  <div id="app">
    <talk-content
      ...
      @changebackgroundandlogo="changebackgroundandlogo"
    ></talk-content>
    ...
    <right-button-bar
      ...
      @openFluent="fluentsetup"
      @closeFluent="backtohome"
      @searchHistoryByDate="searchHistoryByDate"
      :ttsaWork="ttsaWork"
      :ttsapreload="ttsapreload"
      :mute="ttsaMute"
    ></right-button-bar>
    <font-size-change
